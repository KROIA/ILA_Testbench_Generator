...
#include <chrono>
// Params
// <LIBRARY NAME SHORT>=ILATG 
//
#ifndef BUILD_STATIC
	//#pragma message("ILA_TESTBENCH_GENERATOR_LIB is a shared library")
	#if defined(ILA_TESTBENCH_GENERATOR_LIB)
		#define ILA_TESTBENCH_GENERATOR_EXPORT __declspec(dllexport)
	#else
		#define ILA_TESTBENCH_GENERATOR_EXPORT __declspec(dllimport)
	#endif
#else 
	//#pragma message("ILA_TESTBENCH_GENERATOR_LIB is a static library")
	#define ILA_TESTBENCH_GENERATOR_EXPORT
#endif
